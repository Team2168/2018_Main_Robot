...
public class OI {
	...
	private OI() {
	    ...
	    operatorJoystick.ButtonRightTrigger().whenPressed(new CloseIntake()); //open for comp bot
...
//		///////////////PID testing//////////////////////////////////////////////////////
		...
		testJoystick.ButtonA().whenPressed(new ExtendPivotPiston());
		testJoystick.ButtonB().whenPressed(new RetractPivotPiston());
