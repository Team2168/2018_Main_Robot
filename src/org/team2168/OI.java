...
public class OI {
	...
	private OI() {
		...
		// operatorJoystick.ButtonY().whenPressed(new RotateTurretAnglePIDZZZ(-79.7,
		// 0.7, 0.2, 0.2,true));
		...
		// turret
		// operatorJoystick.ButtonRightDPad().whileHeld(new
		// DriveTurretWithConstant(RobotMap.TURRET_MAX_DRIVE));
		// operatorJoystick.ButtonLeftDPad().whileHeld(new
		// DriveTurretWithConstant(-RobotMap.TURRET_MAX_DRIVE));
		...
		// operatorJoystick.ButtonRightBumper().whenPressed(new
		// LowerGearArmDANGEROUS());
		...
		// operatorJoystick.ButtonStart().whileHeld(new
		// DriveGearIntakeRollerWithConstant(-1.0));
		...
		// operatorJoystick.ButtonLeftTrigger().whileHeld(new
		// DriveIntakeWithConstant(1.0));
		// operatorJoystick.ButtonLeftTrigger().whileHeld(new
		// DriveAgitatorWithConstant(1.0));
		// operatorJoystick.ButtonLeftBumper().whenReleased(new RaiseBallIntakeArm());
		// operatorJoystick.ButtonLeftBumper().whileHeld(new
		// DriveIntakeWithConstant(-1.0));
		// operatorJoystick.ButtonLeftBumper().whileHeld(new
		// DriveAgitatorWithConstant(-1.0));
		...
		// operatorJoystick.ButtonLeftStick().whenPressed(new
		// RotateTurretAnglePIDZZZ(0.0, 0.7, 0.2, 0.2));
		// operatorJoystick.ButtonLeftStick().whenPressed(new
		// DriveShooterPIDSpeed(3600));
		...
		// Emergency Gear Pickup
		// driverOperatorEJoystick.ButtonX().whenPressed(new
		// AutomaticGearIntakeDANGEROUS());
		...
		// driverOperatorEJoystick.ButtonY().whenPressed(new
		// RotateTurretAnglePIDZZZ(79.7, 0.7, 0.2, 0.2,true));
		// driverOperatorEJoystick.ButtonY().whenPressed(new
		// DriveShooterPIDSpeed(3000));

		// Fire
		// driverOperatorEJoystick.ButtonA().whileHeld(new
		// DriveElevatorWithConstant(0.75));
		// driverOperatorEJoystick.ButtonA().whileHeld(new
		// DriveIndexerWithConstant(0.75));
		// driverOperatorEJoystick.ButtonA().whileHeld(new
		// DriveIntakeWithConstant(0.75));
		// driverOperatorEJoystick.ButtonA().whileHeld(new
		// DriveAgitatorWithConstant(0.75));

		// Kill Shooter
		// driverOperatorEJoystick.ButtonB().whenPressed(new ShooterPIDPause());
		// driverOperatorEJoystick.ButtonB().whenPressed(new
		// DriveTurretWithConstant(0.0));

		// turret
		// driverOperatorEJoystick.ButtonRightDPad().whileHeld(new
		// DriveTurretWithConstant(RobotMap.TURRET_MAX_DRIVE));
		// driverOperatorEJoystick.ButtonLeftDPad().whileHeld(new
		// DriveTurretWithConstant(-RobotMap.TURRET_MAX_DRIVE));
		// driverOperatorEJoystick.ButtonUpDPad().whileHeld(new
		// DriveHoodUpWithButton());
		// driverOperatorEJoystick.ButtonDownDPad().whileHeld(new
		// DriveHoodDownWithButton());

		// Gear Assembly
		// driverOperatorEJoystick.ButtonRightTrigger().whileHeld(new
		// AutomaticGearIntake());
		// driverOperatorEJoystick.ButtonRightTrigger().whenReleased(new
		// RaiseGearArm());
		// driverOperatorEJoystick.ButtonRightBumper().whenPressed(new
		// LowerGearArmDANGEROUS());
		// driverOperatorEJoystick.ButtonRightBumper().whenReleased(new RaiseGearArm());
		// driverOperatorEJoystick.isPressedButtonRightBumper()/whenPressed .... SCORE
		// GEAR

		// Spit Gear Intake
		// driverOperatorEJoystick.ButtonStart().whenPressed(new
		// LowerGearArmDANGEROUS());
		// driverOperatorEJoystick.ButtonStart().whileHeld(new
		// DriveGearIntakeRollerWithConstant(-1.0));
		// driverOperatorEJoystick.ButtonStart().whenReleased(new RaiseGearArm());

		// Ball Intake Assembly
		// driverOperatorEJoystick.ButtonLeftTrigger().whenPressed(new
		// LowerBallIntakeArm());
		// driverOperatorEJoystick.ButtonLeftTrigger().whileHeld(new
		// DriveIntakeWithConstant(1.0));
		// driverOperatorEJoystick.ButtonLeftTrigger().whileHeld(new
		// DriveAgitatorWithConstant(1.0));
		// driverOperatorEJoystick.ButtonLeftBumper().whenReleased(new
		// RaiseBallIntakeArm());
		// driverOperatorEJoystick.ButtonLeftBumper().whileHeld(new
		// DriveIntakeWithConstant(-1.0));
		// driverOperatorEJoystick.ButtonLeftBumper().whileHeld(new
		// DriveAgitatorWithConstant(-1.0));

		// Climber
		// driverOperatorEJoystick.ButtonBack().whileHeld(new
		// DriveClimberWithConstant(1.0));

		// Boiler Shot Angle
		// driverOperatorEJoystick.ButtonLeftStick().whenPressed(new
		// SetHoodToAngle(45.0));
		// driverOperatorEJoystick.ButtonLeftStick().whenPressed(new
		// RotateTurretAnglePIDZZZ(0.0, 0.7, 0.2, 0.2));
		// driverOperatorEJoystick.ButtonLeftStick().whenPressed(new
		// DriveShooterPIDSpeed(3600));
		// driverOperatorEJoystick.ButtonRightStick().whenPressed(new
		// DriveWithJoystickEmergencyJoystick());
		...
		// testJoystick.ButtonRightDPad().whileHeld(new
		// DriveElevatorWithConstant(-1.0));
		// testJoystick.ButtonRightBumper().whileHeld(new
		// DriveGearIntakeRollerWithConstant(1.0));
		// testJoystick.ButtonLeftBumper().whileHeld(new
		// DriveGearIntakeRollerWithConstant(-1.0));
		...
		// pidTestJoystick.ButtonB().whenPressed(new RotateXDistancePIDZZZ(25, 0.8,
		// 0.25, 1));
		// pidTestJoystick.ButtonX().whenPressed(new
		// RotateXDistancePIDZZZCameraWithGyro(0, RobotMap.ROTATE_POSITION_CAMERA_MAX,
		// RobotMap.ROTATE_POSITION_CAMERA_MIN, 0.2));
		...
		// pidTestJoystick.ButtonY().whenPressed(new EnableTurretAnglePIDZZZ(0, 0.7,
		// 0.1, 0.2,true));

		// Turret to 20 off target with camera (X)
		// pidTestJoystick.ButtonX().whenPressed(new EnableTurretAnglePIDZZZ(60, 0.7,
		// 0.1, 0.2,true));

		// Turret -20 off target with camera (A)
		// pidTestJoystick.ButtonA().whenPressed(new EnableTurretAnglePIDZZZ(-60, 0.7,
		// 0.1, 0.2,true));
		...
		// Turret (B)
		// pidTestJoystick.ButtonB().whenPressed(new TurretToAnglePIDZZZCameraWithPot(0,
		// 0.7, 0.1, 0.2));

		// Turret movement
		// pidTestJoystick.ButtonRightDPad().whileHeld(new
		// DriveTurretWithConstant(RobotMap.TURRET_MAX_DRIVE));
		// pidTestJoystick.ButtonLeftDPad().whileHeld(new
		// DriveTurretWithConstant(-RobotMap.TURRET_MAX_DRIVE));
		...
		// pidTestJoystick.ButtonStart().whenPressed(new
		// RotateXDistancePIDZZZCameraWithGyro(0, RobotMap.ROTATE_POSITION_CAMERA_MAX,
		// RobotMap.ROTATE_POSITION_CAMERA_MIN, 0.5));
		...
		// ConsolePrinter.putNumber("Left Stick Raw Value", () -> {return
		// Robot.oi.driverJoystick.getLeftStickRaw_Y();}, true, false);
		// ConsolePrinter.putNumber("Right Stick Raw Value", () -> {return
		// Robot.oi.driverJoystick.getRightStickRaw_Y();}, true, false);
		//
		// ConsolePrinter.putNumber("Left Trigger Raw Value", () -> {return
		// Robot.oi.driverJoystick.getLeftTriggerAxisRaw();}, true, false);
		// ConsolePrinter.putNumber("Right Trigger Raw Value", () -> {return
		// Robot.oi.driverJoystick.getRightTriggerAxisRaw();}, true, false);
		//
		// ConsolePrinter.putNumber("Operator Left Stick Raw Value", () -> {return
		// Robot.oi.operatorJoystick.getLeftStickRaw_Y();}, true, false);
		// ConsolePrinter.putNumber("Operator Right Stick Raw Value", () -> {return
		// Robot.oi.operatorJoystick.getRightStickRaw_Y();}, true, false);
		//
		// ConsolePrinter.putNumber("Operator Left Trigger Raw Value", () -> {return
		// Robot.oi.operatorJoystick.getLeftTriggerAxisRaw();}, true, false);
		// ConsolePrinter.putNumber("Operator Right Trigger Raw Value", () -> {return
		// Robot.oi.operatorJoystick.getRightTriggerAxisRaw();}, true, false);
