...
public class Elevator extends Subsystem {
	...
	private Elevator() {
		...
		elevatorBrake = new DoubleSolenoid(RobotMap.ELEVATOR_BRAKE_APPLY, RobotMap.ELEVATOR_BRAKE_RELEASE);
	...
	/**
	 * Drives the first Elevator motor at a speed from -1 to 1 where 1 is forward
	...
	/**
	 * Drives the second Elevator motor at a speed from -1 to 1 where 1 is forward
	 * and negative 1 is backwards
	 * 
	 * @param speed
	 */
	...
	/**
	 * Drives the third Elevator motor at a speed from -1 to 1 where 1 is forward
	 * and negative 1 is backwards
	 * 
	 * @param speed
	 */
	...
	/**
	 * Drives all elevator Motors at a speed from -1 to 1 where 1 is forward and
